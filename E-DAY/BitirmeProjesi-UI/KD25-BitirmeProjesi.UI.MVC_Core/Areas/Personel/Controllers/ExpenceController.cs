        ...
        public async Task<IActionResult> AddExpence(AddExpenceForm_VM addExpence)
        {
            ...
            try
            {
                ...
                */
                ...
                {
                    AppUserID = int.Parse("1"), // 1 yerine AppUserID olacak ve Token'dan gelecek
                ...
                Console.WriteLine("userid from binding: " + addExpence.Expence.AppUserID);
